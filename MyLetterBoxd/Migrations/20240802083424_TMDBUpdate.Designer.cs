...
namespace MyLetterBoxd.Migrations
{
    ...
    [Migration("20240802083424_TMDBUpdate")]
    partial class TMDBUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyLetterBoxd.Models.Cast", b =>
                {
                    b.HasOne("MyLetterBoxd.Models.Film", null)
                        .WithMany("Actors")
                    ...
                    b.HasOne("MyLetterBoxd.Models.Serie", null)
                        .WithMany("Actors")
            ...
            modelBuilder.Entity("MyLetterBoxd.Models.Genre", b =>
                {
                    b.HasOne("MyLetterBoxd.Models.Entertainment", null)
                        .WithMany("Genre")
                        .HasForeignKey("EntertainmentID");
                });
